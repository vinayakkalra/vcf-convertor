...
$target_file = $target_dir .$newfilename;
 ...
 if(isset($_POST["submit"])) {
   $check = getimagesize($_FILES["fileToUpload_mobile"]["tmp_name"]);
   if($check !== false) {
...
//  }
 ...
 // if everything is ok, try to upload file
   ...
   if (move_uploaded_file($_FILES["fileToUpload_mobile"]["tmp_name"], $target_file)) {
  ...
  $id = $id + 1;
    ...
    // echo "The file ". basename( $_FILES["fileToUpload_mobile"]["name"]). " has been uploaded.";
  } else {
